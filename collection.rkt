...
(define (collection-first stream)
  (stream-first stream))

(define (collection-rest stream)
  (stream-rest stream))

(define (collection-empty? stream)
  (stream-empty? stream))

(define empty-collection empty-stream)

(define (collection-map func stream)
  (stream-map func stream))

(define (collection-filter func stream)
